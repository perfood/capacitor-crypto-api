var capacitorCryptoApi = (function (exports, core) {
    ...
    class CryptoApiWeb extends core.WebPlugin {
        ...
        async registerPasskey(options) {
            const createOptions = Object.assign(Object.assign({}, options), { challenge: this.base64urlToBuffer(options.challenge), user: Object.assign(Object.assign({}, options.user), { id: this.base64urlToBuffer(options.user.id) }) });
