var capacitorCryptoApi = (function (exports, core) {
  'use strict';
  ...
  class CryptoApiWeb extends core.WebPlugin {
    ...
    async registerPasskey(options) {
      const createOptions = Object.assign(Object.assign({}, options), {
        challenge: base64ToArrayBuffer(options.challenge),
        user: Object.assign(Object.assign({}, options.user), { id: base64ToArrayBuffer(options.user.id) }),
      });
      ...
      const authenticatorAttachment =
        'authenticatorAttachment' in publicKeyCredential ? publicKeyCredential.authenticatorAttachment : undefined;
      return {
    ...
    async authenticateWithPasskey(options) {
      ...
      const webOptions = Object.assign(Object.assign({}, options), {
        challenge: base64ToArrayBuffer(options.challenge),
        allowCredentials,
      });
